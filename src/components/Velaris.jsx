...
// Living gradient background — an animated simplex-noise WebGL shader with
// colour blending, a soft vignette glow and film grain. Adapted to the
// project (JSX, no cn) with a solid fallback and offscreen/reduced-motion
// pausing so it stays cheap.
